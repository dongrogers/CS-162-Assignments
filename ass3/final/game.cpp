...
** Parameters: none
** Pre-Conditions: no gen array yet
** Post-Conditions: none
*********************************************************************/ 
...
int Game::view_purchase(int index, int indexapt, int indexcomp){
	...
	cout << "What property do you want to buy? Enter a number (4 to Cancel)" << endl;
	if(list.get_num_house() > 0){
	cout << "1. House" << endl;
